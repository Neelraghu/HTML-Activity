...
function ActivityScore(id, position,useranswer) {
    if (id == 12 && position == "dont") {
        TotalScore = TotalScore + 1;
        right(useranswer);
    }
    else if (id == 11 && position == "do") {
        TotalScore = TotalScore + 1;
        right(useranswer);
    }
    else  if (id == 10 && position == "do") {
        TotalScore = TotalScore + 1;
        right(useranswer);
    }
    else  if (id == 9 && position == "dont") {
        TotalScore = TotalScore + 1;
        right(useranswer);
    }
    else  if (id == 8 && position == "dont") {
        TotalScore = TotalScore + 1;
        right(useranswer);
    }
    ...
    else if (id == 5 && position == "do") {
        TotalScore = TotalScore + 1;
        right(useranswer);
    }
    else  if (id == 4 && position == "dont") {
        TotalScore = TotalScore + 1;
        right(useranswer);
    }
    else  if (id == 3 && position == "dont") {
        TotalScore = TotalScore + 1;
        right(useranswer);
    }
